...
This document covers the key aspects of securing communication and authentication for your interactions with the BaaS API. Use the method(s) best suited to your application's security and functional requirements.